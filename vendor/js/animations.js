...
$(document).ready(function () {
  ...
  question_slide_btn_left.on("click", function () {
    ...
    if (current_posX < 0) {
      ...
      slide_holder.css("transform", "translateX(" + (parseInt(current_posX) + 438) + "px)");
      // 애니메이션이 끝난 뒤에 버튼 숨김 여부를 체크한다.
      setTimeout(function () {
        btn_show_and_hide("page1")
      }, 200);
    }
  });
...
var btn_show_and_hide = function(target) {
